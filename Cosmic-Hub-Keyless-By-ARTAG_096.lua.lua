...
if localVersion ~= version then
    Rayfield:Notify({Title = "Cosmic Hub Keyless By ARTAG_096",Content = "Script.Ftap",Duration = 6.5,Image = 4483362458,})
...
local Window = Rayfield:CreateWindow({
    Name = "Cosmic Hub Keyless By ARTAG_096",
    Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
    LoadingTitle = "Cosmic Hub Keyless By ARTAG_096",
    LoadingSubtitle = "Deobfuscated",
    ...
    ConfigurationSaving = {
       ...
       FileName = "Cosmic Hub By ARTAG_096"
    },
